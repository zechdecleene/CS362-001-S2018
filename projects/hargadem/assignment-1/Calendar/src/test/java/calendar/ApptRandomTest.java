   ...
   /**
     ...
     */
	 @Test
	  public void radnomtest()  throws Throwable  {
		...
		try{
			for (int iteration = 0; elapsed < 5000; iteration++) {
	...
	//			System.out.println(" Seed:"+randomseed );
			...
			for (int i = 0; i < NUM_TESTS; i++) {
				 ...
				 elapsed = (Calendar.getInstance().getTimeInMillis() - startTime);
			        if((iteration%10000)==0 && iteration!=0 )
			              System.out.println("elapsed time: "+ elapsed + " of 5000");
		...
		//			System.out.println(" Seed:"+randomseed );
				...
				apptA.setValid();
				apptB.setValid();
				apptB.isOn(startDayCorrect, startMonthCorrect, startYearCorrect);
				apptB.isOn(startDayAny, startMonthAny, startYearAny);
					 elapsed = (Calendar.getInstance().getTimeInMillis() - startTime);
								if((iteration%10000)==0 && iteration!=0 )
											System.out.println("elapsed time: "+ elapsed + " of 5000");
